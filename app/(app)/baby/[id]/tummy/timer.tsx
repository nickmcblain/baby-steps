...
export default function TummyTimerScreen() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (cancelled) return;
      if (saved?.kind === "tummy" && saved.babyId === String(babyId)) {
  ...
  return (
    <Screen onBack={() => router.back()}>
      ...
      <Text style={styles.hint}>
        Start when they go on their tummy. Keeps timing on the Lock Screen /
        Dynamic Island while the app is away.
      </Text>
